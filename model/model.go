...
type Veiculo struct {
	...
	CodigoLinha string `json:"codigoinha" bson:"codigolinha"` // Prefixo da Linha (3 caracteres)
	...
	Situacao1   string `json:"situacao1" bson:"situacao1"`    // Situação processada do veículo
